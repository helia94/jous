...
stat_api = Blueprint("user_api", __name__)



@stat_api.route("/userquestions", methods=["POST"])
@stat_api.route("/userquestions/<int:offset>", methods=["POST"])
...
@stat_api.route("/useranswers", methods=["POST"])
...
@stat_api.route("/useranswerstoquestions", methods=["GET"])
@jwt_required()
