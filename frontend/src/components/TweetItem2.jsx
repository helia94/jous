...
class TweetItem2 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            groupName: "",
            likes: props.likes, // store initial likes coming from props
            mobile: false,
            minHeight: 200
        };
    }
    ...
    likeTweet = (e) => {
        Axios.post("/api/likequestion/" + this.props.id, null, {
            ...
            if (res.data.success) {
                // increment local state so UI updates without refresh
    ...
    postToGroupClick = (e) => {
        this.setState(prevState => ({
            showGroupNameForm: !prevState.showGroupNameForm
        }));
    }
            ...
            <div className="ui fluid card" id={this.props.id} style={{ minHeight: this.state.minHeight }}>
                ...
                <div className="extra content">
                    <div className="ui mini icon buttons">
                        <div className="ui labeled button" tabIndex="0" data-tooltip="like">
                            ...
                            {/* use state.likes here so it updates immediately */}
                        ...
                        <div className="ui basic button" data-tooltip="share" onClick={this.copyQuestionAddressToKeyboard}>
                ...
                {this.props.isLoggedIn && this.state.showGroupNameForm && (
                    <form className="ui small form" onSubmit={this.handleSubmit}>
                        <div className="field" value={this.state.groupName} onChange={this.handleInputChange}>
                            <label>Group name</label>
                            <input type="text" name="name" placeholder="OlympusJous" />
                        </div>
